...
object SortedNeighborhood {
  ...
  /**
    ...
    * @return the blocks
    */
  def createBlocks(profiles: RDD[Profile], wSize: Int, separatorIDs: Array[Long] = Array.emptyLongArray, keysToExclude: Iterable[String] = Nil, removeStopWords: Boolean = false,
