...
object CommonJsFunctions {
  ...
  def prepareData(profiles: RDD[Profile], fields: List[String] = List.empty[String]): RDD[(Long, Array[Int])] = {
  ...
  def tokenizeAndSort(documents: RDD[(Long, String)]): RDD[(Long, Array[Int])] = {
  ...
  /**
    ...
    */
  def computeTokenCount(tokenizedDocuments: RDD[(Long, Set[String])]): RDD[(String, (Double, Int))] = {
  ...
  /**
    ...
    */
  def sortTokens(tokenizedDocuments: RDD[(Long, Set[String])],
                 tekenCount_broadcast: Broadcast[scala.collection.Map[String, (Double, Int)]]): RDD[(Long, Array[Int])] = {
  ...
  /**
    ...
    * @return
    */
  def buildPrefixIndex(tokenizedDocOrd: RDD[(Long, Array[Int])], threshold: Double): RDD[(Long, Array[TokenDocumentInfo])] = {
