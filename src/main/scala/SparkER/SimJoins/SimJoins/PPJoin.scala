...
object PPJoin {
  ...
  /**
    ...
    **/
  def getCandidatePairs(prefixIndex: RDD[(Int, Array[(Long, Array[Int])])], threshold: Double, separatorID: Long): RDD[((Long, Array[Int]), (Long, Array[Int]))] = {
    /**
    ...
    repartitionIndex.flatMap {
      case (docs, tokenId) =>
        val results = scala.collection.mutable.Set[((Long, Array[Int]), (Long, Array[Int]))]()
        var i = 0
  ...
  /**
    ...
    **/
  def buildPrefixIndex(tokenizedDocOrd: RDD[(Long, Array[Int])], threshold: Double): RDD[(Int, Array[(Long, Array[Int])])] = {
  ...
  def getCandidates(tokenizedDocSort: RDD[(Long, Array[Int])], threshold: Double, separatorID: Long = -1): RDD[((Long, Array[Int]), (Long, Array[Int]))] = {
  ...
  /**
    ...
    **/
  def getMatches(documents: RDD[(Long, String)], threshold: Double, separatorID: Long = -1): RDD[(Long, Long, Double)] = {
    val log = LogManager.getRootLogger
