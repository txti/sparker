...
object EDJoin {
  def buildPrefixIndex(
    sortedDocs: RDD[(Long, String, Array[(Int, Int)])],
    qgramLen: Int, threshold: Int
    ): RDD[(Int, Array[(Long, Int, Array[(Int, Int)], String)])] = {
  ...
  def getCandidatePairs(prefixIndex: RDD[(Int, Array[(Long, Int, Array[(Int, Int)], String)])], qgramLength: Int, threshold: Int): RDD[((Long, String), (Long, String))] = {
    /**
    ...
    repartitionIndex.flatMap { case (block, blockId) =>
      val results = new scala.collection.mutable.HashSet[((Long, String), (Long, String))]()
  ...
  def getCandidates(documents: RDD[(Long, String)], qgramLength: Int, threshold: Int): RDD[((Long, String), (Long, String))] = {
  ...
  /**
    ...
    * */
  def getMatches(documents: RDD[(Long, String)], qgramLength: Int, threshold: Int): RDD[(Long, Long)] = {
