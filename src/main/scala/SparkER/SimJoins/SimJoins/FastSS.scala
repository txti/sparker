...
object FastSS2 {
  ...
  /**
    ...
    **/
  def performDeletions(recordId: Long, str: String, sk: Int): Iterable[(String, (Long, String))] = {

    var delPositions = ""

    val results = new scala.collection.mutable.ArrayBuffer[(String, (Long, String))]()
  ...
  /**
    ...
    **/
  def buildIndex(profiles: RDD[(Long, String)], threshold: Int): RDD[(String, Array[(Long, Iterable[String])])] = {
  ...
  /**
    ...
    **/
  def getIntMatches(index: RDD[(String, Array[(Long, Iterable[String])])], threshold: Int, maxProfileId: Long): RDD[(Long, Long)] = {
  ...
  /**
    ...
    **/
  def getMatches(profiles: RDD[(Long, String)], threshold: Int): RDD[(Long, Long)] = {
